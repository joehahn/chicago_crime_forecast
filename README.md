...
| 4. Train skforecast model | `python3 forecast_model.py` | `models/forecaster.joblib`, [`docs/forecast_dashboard.html`](https://joehahn.github.io/chicago_crime_forecast/forecast_dashboard.html) |
